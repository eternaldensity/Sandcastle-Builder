Molpy.DefineGUI=function()
{
	...
	Molpy.sizableOrder=['View','File','Links','OptionsBody','Stats','Log','Export','SandTools','CastleTools','Shop','Inventory','Layouts','Codex','Alerts','SandStats','GlassStats','NinjaStats','OtherStats'];
