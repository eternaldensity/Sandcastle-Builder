Molpy.DefineGUI=function()
{
	...
	Molpy.PaintStats=function()
	{
		...
		g('discoveriesstat').innerHTML=Molpify(Molpy.groupBadgeCounts.discov,4)||0;		
		g('sandmonstat').innerHTML=Molpify(Molpy.groupBadgeCounts.monums,4)||0;		
		g('glassmonstat').innerHTML=Molpify(Molpy.groupBadgeCounts.monumg,4)||0;		
